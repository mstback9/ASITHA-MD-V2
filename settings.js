...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=SzYwGBZD#NgVqqYEXw9gkGSrj2B2qW-KwDMVf_d0L2NBXTm65tpI' : process.env.SESSION_ID,
...
NEWS_JID: process.env.NEWS_JID === undefined ? "923239956476@g.us" : process.env.NEWS_JID,
